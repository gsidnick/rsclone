...
export const libraryGames = [
  {
    nameRU: 'Переведи и произнеси слово',
    name: 'Translate the word by your voice',
    descriptionRU: 'Переведите и произнесите слово на экране',
    description: 'Translate and say the word on the screen and check your spelling',
    image:
  ...
  },
  {
    ...
    descriptionRU: 'Соберите правильный перевод предложенного слова по буквам',
    description: 'Assemble the correct spelling of the suggested word',
    image:
      'https://ouch-cdn2.icons8.com/z6SdE9V5igFri3ElNWyAuv3Fy3mw70QtNAbJBnCiSQw/rs:fit:252:456/extend:false/wm:1:re:0:0:0.8/wmid:ouch/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9zdmcvODUx/L2RhODljOTg1LWJi/ZTMtNGEwNC1hZTNm/LWY2ZjBlNjRjNjdm/Yi5zdmc.png',
  },
  {
